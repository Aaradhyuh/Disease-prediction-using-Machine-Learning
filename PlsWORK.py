...
dst = Button(root, text="DecisionTree", command=DecisionTree,bg="#9ACD9A",fg="#333333")
dst.grid(row=8, column=3,padx=10)

rnf = Button(root, text="Randomforest", command=randomforest,bg="#9ACD9A",fg="#333333")
rnf.grid(row=9, column=3,padx=10)

lr = Button(root, text="NaiveBayes", command=NaiveBayes,bg="#9ACD9A",fg="#333333")
